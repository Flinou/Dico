...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    private Spannable generateNotifContent(Context context, String notifContent) {
        ...
        wordOfTheDayNotif.setSpan(new StyleSpan(android.graphics.Typeface.BOLD), wordDayStartPos, wordDayStartPos + notifContent.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
